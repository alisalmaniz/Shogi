...
public class B extends Man{
        ...
        if(board[i][j].charAt(2)=='1'){
            ...
            if((i+2<9 && j+2<9 && board[i+1][j+1].equals("----")) && (board[i+2][j+2].equals("----") || board[i+2][j+2].charAt(1)=='2' || board[i+2][j+2].charAt(2)=='2') ){
                change[0]=String.valueOf(10*(i+2)+(j+2));
                change[1]=board[i+2][j+2];
                change3++;
            }
            if((i+3<9 && j+3<9 && board[i+1][j+1].equals("----") &&  board[i+2][j+2].equals("----")) && (board[i+3][j+3].equals("----") || board[i+3][j+3].charAt(1)=='2' || board[i+3][j+3].charAt(2)=='2') ){
                change[0]=String.valueOf(10*(i+3)+(j+3));
                change[1]=board[i+3][j+3];
                change3++;
            }
            if((i+4<9 && j+4<9 && board[i+1][j+1].equals("----") && board[i+2][j+2].equals("----") && board[i+3][j+3].equals("----")) && (board[i+4][j+4].equals("----") || board[i+4][j+4].charAt(1)=='2' || board[i+4][j+4].charAt(2)=='2') ){
                change[0]=String.valueOf(10*(i+4)+(j+4));
                change[1]=board[i+4][j+4];
                change3++;
            }
            if((i+5<9 && j+5<9 && board[i+1][j+1].equals("----") && board[i+2][j+2].equals("----") && board[i+3][j+3].equals("----") && board[i+4][j+4].equals("----")) && (board[i+5][j+5].equals("----") || board[i+5][j+5].charAt(1)=='2' || board[i+5][j+5].charAt(2)=='2') ){
                change[0]=String.valueOf(10*(i+5)+(j+5));
                change[1]=board[i+5][j+5];
                change3++;
            }
            if((i+6<9 && j+6<9 && board[i+1][j+1].equals("----") && board[i+2][j+2].equals("----") && board[i+3][j+3].equals("----") && board[i+4][j+4].equals("----") && board[i+5][j+5].equals("----") ) && (board[i+6][j+6].equals("----") || board[i+6][j+6].charAt(1)=='2' || board[i+6][j+6].charAt(2)=='2') ){
                change[0]=String.valueOf(10*(i+6)+(j+6));
                change[1]=board[i+6][j+6];
                change3++;
            }
            if((i+7<9 && j+7<9 && board[i+1][j+1].equals("----") && board[i+2][j+2].equals("----") && board[i+3][j+3].equals("----") && board[i+4][j+4].equals("----") && board[i+5][j+5].equals("----") && board[i+6][j+6].equals("----") ) && (board[i+7][j+7].equals("----") || board[i+7][j+7].charAt(1)=='2' || board[i+7][j+7].charAt(2)=='2') ){
                change[0]=String.valueOf(10*(i+7)+(j+7));
                change[1]=board[i+7][j+7];
                change3++;
            }
            if((i+8<9 && i+8<9 && board[i+1][j+1].equals("----") && board[i+2][j+2].equals("----") && board[i+3][j+3].equals("----") && board[i+4][j+4].equals("----") && board[i+5][j+5].equals("----") && board[i+6][j+6].equals("----") && board[i+7][j+7].equals("----") ) && (board[i+8][j+8].equals("----") || board[i+8][j+8].charAt(1)=='2' || board[i+8][j+8].charAt(2)=='2') ){
            ...
            if((i-2>=0 && j-2>=0 && board[i-1][j-1].equals("----")) && (board[i-2][j-2].equals("----") || board[i-2][j-2].charAt(1)=='2' || board[i-2][j-2].charAt(2)=='2') ){
                change[0]=String.valueOf(10*(i-2)+(j-2));
                change[1]=board[i-2][j-2];
                change3++;
            }
            if((i-3>=0 && j-3>=0 && board[i-1][j-1].equals("----") &&  board[i-2][j-2].equals("----")) && (board[i-3][j-3].equals("----") || board[i-3][j-3].charAt(1)=='2' || board[i-3][j-3].charAt(2)=='2') ){
                change[0]=String.valueOf(10*(i-3)+(j-3));
                change[1]=board[i-3][j-3];
                change3++;
            }
            if((i-4>=0 && j-4>=0 && board[i-1][j-1].equals("----") && board[i-2][j-2].equals("----") && board[i-3][j-3].equals("----")) && (board[i-4][j-4].equals("----") || board[i-4][j-4].charAt(1)=='2' || board[i-4][j-4].charAt(2)=='2') ){
                change[0]=String.valueOf(10*(i-4)+(j-4));
                change[1]=board[i-4][j-4];
                change3++;
            }
            if((i-5>=0 && j-5>=0 && board[i-1][j-1].equals("----") && board[i-2][j-2].equals("----") && board[i-3][j-3].equals("----") && board[i-4][j-4].equals("----")) && (board[i-5][j-5].equals("----") || board[i-5][j-5].charAt(1)=='2' || board[i-5][j-5].charAt(2)=='2') ){
                change[0]=String.valueOf(10*(i-5)+(j-5));
                change[1]=board[i-5][j-5];
                change3++;
            }
            if((i-6>=0 && j-6>=0 && board[i-1][j-1].equals("----") && board[i-2][j-2].equals("----") && board[i-3][j-3].equals("----") && board[i-4][j-4].equals("----") && board[i-5][j-5].equals("----") ) && (board[i-6][j-6].equals("----") || board[i-6][j-6].charAt(1)=='2' || board[i-6][j-6].charAt(2)=='2') ){
                change[0]=String.valueOf(10*(i-6)+(j-6));
                change[1]=board[i-6][j-6];
                change3++;
            }
            if((i-7>=0 && j-7>=0 && board[i-1][j-7].equals("----") && board[i-2][j-2].equals("----") && board[i-3][j-3].equals("----") && board[i-4][j-4].equals("----") && board[i-5][j-5].equals("----") && board[i-6][j-6].equals("----") ) && (board[i-7][j-7].equals("----") || board[i-7][j-7].charAt(1)=='2' || board[i-7][j-7].charAt(2)=='2') ){
                change[0]=String.valueOf(10*(i-7)+(j-7));
                change[1]=board[i-7][j-7];
                change3++;
            }
            if((i-8>=0 && j-8>=0 && board[i-1][j-1].equals("----") && board[i-2][j-2].equals("----") && board[i-3][j-3].equals("----") && board[i-4][j-4].equals("----") && board[i-5][j-5].equals("----") && board[i-6][j-6].equals("----") && board[i-7][j-7].equals("----") ) && (board[i-8][j-8].equals("----") || board[i-8][j-8].charAt(1)=='2' || board[i-8][j-8].charAt(2)=='2') ){
                change[0]=String.valueOf(10*(i-8)+(j-8));
                change[1]=board[i-8][j-8];
                change3++;
            }
